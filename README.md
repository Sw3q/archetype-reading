...
1. **The Gallery** — swipe through the whole deck of archetypes; keep the ones you recognize in yourself.
...
npm run extract  # regenerate src/data/archetypes.ts from scripts/deck.json
```
